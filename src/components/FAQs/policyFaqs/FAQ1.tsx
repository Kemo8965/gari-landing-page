                            ...
                            <div className="font-medium rounded-sm text-lg px-2 py-3 flex text-gray-800 flex-row-reverse mt-2 cursor-pointer bg-white hover:bg-white">
                                ...
                                <button className="bg-gari lg:float-right float-right ml-2 px-4 text-white rounded-lg lg:border-gray-200 border-white"
                                    ...
                                    >
                                      ...
                                      <section className="text-gray-800 leading-relaxed" {...getCollapseProps()}>As Gari, we currently offer two plans under our motor private insurance solution. This comprises of a superior Comprehensive that covers all benefits under a motor private cover and the standard legally required Third party only (TPO) cover.</section> 
                                      </div>
