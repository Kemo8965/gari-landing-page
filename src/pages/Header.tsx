      ...
      {({ open }) => (
        <>
              ...
              <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div className="text-center pl-8 lg:text-left">
                  ...
                  <div className="mt-5 sm:mt-8 flex  sm:flex sm:justify-center lg:justify-start">
                      ...
                      <a
                        href="#"
                        className="md:py-4 md:text-lg md:px-0"
                       // className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-5"
                      >
                        <img
                      ...
                      <a
                        href="#"
                        className="md:py-4 md:text-lg md:px-5"
          ...
          <div className=" lg:visible invisible lg:flex hidden lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img
              className="h-50 lg:mr-40 w-full object-cover h-6 md:h-96 lg:w-90 lg:h-full "
